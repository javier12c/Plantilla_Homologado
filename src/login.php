...
<body class="">
    ...
    <main class="md:flex md:flex-row md:mt-24 justify-center items-center">
        <div class="md:w-full md:max-w-xs bg-login shadow-md">
            <h1 class=" font-bold uppercase text-center p-6 text-color-login">login</h1>
            <form class=" rounded px-8 pt-6 pb-8 mb-4 ml-5 mr-5" action="UsuarioPrincipal.php">
                <div class="mb-4">
                    ...
                    <div class="relative mb-6">
                        <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                            <svg aria-hidden="true" class="w-5 h-5 text-color-iconos" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                            </svg>
                        </div>
                        <input type="text" id="input-group-1" class=" bg-white border border-gray-300 text-sm rounded-lg focus:ring-blue-500 block w-full pl-10 p-2.5 focus:outline-none" placeholder="Escribe tu correo">
                    </div>
                    <div class="mb-6">
                        ...
                        <a class="inline-block align-baseline font-bold text-sm text-color-login cursor-pointer text-color-hover " href="#">
                            ¿Olvido la contraseña?
                        </a>
                    </div>
                    <div class="flex items-center justify-between">
                        <input class="bg-boton  text-color-hover1 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full cursor-pointer" type="submit" value="Ingresar">
                    </div>
            </form>
