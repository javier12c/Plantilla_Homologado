...
<body class="flex flex-col h-screen justify-between ">
    ...
    <div class="p-6 sm:ml-64">
        <div class=" p-6  mt-14 ">
            ...
            <form action="tableUsuarios.php">
                <h1 class=" font-bold text-2xl mt-14 mb-0">Registros de : <span class="text-usuario-letra"> Francisco Javier</span> </h1>
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <select id="dependencia" name="dependencia" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        ...
                                        <option>Dirección de Planificacion Territorial de la Zona Metropolitana</option>
                                    </select>
                                </div>
                            </div>
                ...
                <div class="space-y-14">
                    <div class="border-b border-gray-900/10 p-11 bg-formulario mt-12 rounded-sm">
                        <h2 class=" font-bold text-3xl leading-7 text-gray-900 text-center">Guardado Virtual <span class=" text-red-700	">(En el caso que aplique)*</span></h2>
                        <div class="sm:col-span-6 mt-3">
                            <label for="hipervinculo" class="block text-sm font-medium leading-6 text-gray-900">Hipervinculo</label>
                            <div class="mt-2">
                                <input type="text" name="hipervinculo" id="hipervinculo" autocomplete="hipervinculo" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border-b border-gray-900/10 p-11 bg-formulario mt-12 rounded-sm">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <select id="dependencia" name="dependencia" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        <option>Expediente 1</option>
                                        <option>Expediente 2</option>
                                        <option>Expediente 3</option>
                                    </select>
                                </div>
                            </div>
                            <div class="sm:col-span-3">
                            ...
                            <div class="sm:col-span-3">
                                <button data-modal-target="nombre-expediente" data-modal-toggle="nombre-expediente" class="block text-white bg-empleado-boton bg-empleado-hover focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-full" type="button">
                                    No existe el funcionario
                                </button>
                            </div>
                            <div class="sm:col-span-3">
                ...
                <div class="space-y-14">
                    <div class="border-b border-gray-900/10 p-11 bg-formulario mt-12 rounded-sm">
                        <h2 class=" font-bold text-3xl leading-7 text-gray-900 text-center">Status</h2>
                        <div class="sm:col-span-6 mt-3">
                            <label for="hipervinculo" class="block text-sm font-medium leading-6 text-gray-900">Status</label>
                            <div class="mt-2">
                                <select id="dependencia" name="dependencia" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                ...
                <div class="mt-6 flex items-center justify-end gap-x-6">
                    <input type="submit" value="Guargar" class="rounded-md bg-header boton-hover focus:ring-4 focus:outline-none px-3 py-2 text-sm font-semibold text-white shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-invisible cursor-pointer">
                </div>
            </form>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="px-6 py-6 lg:px-6">
                    ...
                    <form class="space-y-6 " action="#">
                        ...
                        <div class=" pb-8">
                            <label for="puesto" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cargo</label>
    ...
    <!-- Modal2-->
    <div id="nombre-expediente" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative w-full max-w-md max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-hide="nombre-expediente">
                    <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path>
                    </svg>
                    <span class="sr-only">Close modal</span>
                ...
                <div class="px-6 py-6 lg:px-6">
                    ...
                    <form class="space-y-6 " action="#">
                        <div class="mt-10 grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-6">
                                <label for="tdocumento" class="block text-sm font-medium leading-6 text-gray-900">Depedencia o unidad</label>
                                <div class="mt-2">
                                    <select id="dependencia" name="dependencia" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                        <option>Organo Interno</option>
                                        <option>Secretaria General</option>
