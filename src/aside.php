<aside id="logo-sidebar" class="md:fixed md:top-0 md:left-0 md:h-fit z-40 w-64  pt-20   bg-white border-r border-gray-200  dark:bg-gray-800 dark:border-gray-700 " aria-label="Sidebar">
    ...
    <div class="h-full px-3 pb-4  bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="funcionariosPublicos.php" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                    <img src="img/data.svg" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" alt="">
                    <span class="flex-1 ml-3 whitespace-nowrap">Datos de funcionarios</span>
                </a>
            </li>
        </ul>
    </div>
